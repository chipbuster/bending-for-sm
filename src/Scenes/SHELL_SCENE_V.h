...
public:
  ...
  virtual bool buildScene() override {
    ...
    // bool success = TRIANGLE_MESH::readObjFile(_triangleMeshFilename,
    // vertices, triangles); if (!success)
    // {
    //   cout << " Failed to open file " << _triangleMeshFilename.c_str() <<
    //   endl; return false;
    // }
    ...
    _clothSolver = new SHELL::TIMESTEPPER(*_triangleMesh, *_strechingEnergy,
                                          *_bendingEnergy);
