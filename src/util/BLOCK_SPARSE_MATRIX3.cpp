...
BLOCK_SPARSE_MATRIX3::BLOCK_SPARSE_MATRIX3(const SPARSE_MATRIX &A)
    : _totalRows(A.rows()), _totalCols(A.cols()), _totalBlockRows(A.rows() / 3),
      _totalBlockCols(A.cols() / 3) {
...
///////////////////////////////////////////////////////////////////////
MATRIX3 &BLOCK_SPARSE_MATRIX3::operator()(const int blockRow,
                                          const int blockCol) {
  assert(blockRow >= 0);
  assert(blockCol >= 0);
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
const bool BLOCK_SPARSE_MATRIX3::blockExists(const int blockRow,
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
BLOCK_SPARSE_MATRIX3 operator+(const BLOCK_SPARSE_MATRIX3 &A,
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
BLOCK_SPARSE_MATRIX3 operator*(const BLOCK_DIAGONAL_MATRIX3 &A,
                               const BLOCK_SPARSE_MATRIX3 &B) {
  BLOCK_SPARSE_MATRIX3 C(A.rows(), A.cols());
...
///////////////////////////////////////////////////////////////////////
BLOCK_SPARSE_MATRIX3
BLOCK_SPARSE_MATRIX3::scaleLeftRightAdd(const BLOCK_DIAGONAL_MATRIX3 &A,
                                        const BLOCK_DIAGONAL_MATRIX3 &B) {
  BLOCK_SPARSE_MATRIX3 C(A.rows(), A.cols());
  for (int x = 0; x < _totalBlockRows; x++)
    for (auto iter = _blocks[x].begin(); iter != _blocks[x].end(); iter++) {
