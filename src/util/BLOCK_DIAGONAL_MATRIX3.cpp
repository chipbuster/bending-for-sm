...
///////////////////////////////////////////////////////////////////////
MATRIX3 &BLOCK_DIAGONAL_MATRIX3::operator()(const int blockRow,
                                            const int blockCol) {
  assert(blockRow >= 0);
  assert(blockCol >= 0);
...
// if you try to access something off-diagonal, this will bomb
///////////////////////////////////////////////////////////////////////
const MATRIX3 &BLOCK_DIAGONAL_MATRIX3::operator()(const int blockRow,
...
//////////////////////////////////////////////////////////////////////
SPARSE_MATRIX operator*(const BLOCK_DIAGONAL_MATRIX3 &A,
