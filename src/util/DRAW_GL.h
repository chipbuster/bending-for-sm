...
// DEBUG: here while TRIANGLE_MESH and SHELL::TIMESTEPPER are prototyping
// classes
...
void drawStrandMesh(const STRAND_MESH &mesh, const int highlight = -1,
                    const bool drawVertices = false);
void drawStrandMeshOld(const STRAND_MESH &mesh, const int highlight = -1,
                       const bool drawVertices = false);
