...
public:
  ...
  */
  ...
  // friend SPARSE_MATRIX operator*(const SPARSE_MATRIX& A, const
  // BLOCK_DIAGONAL_MATRIX3& B);
  friend SPARSE_MATRIX operator*(const BLOCK_DIAGONAL_MATRIX3 &A,
                                 const SPARSE_MATRIX &B);
  friend SPARSE_MATRIX operator+(const SPARSE_MATRIX &A,
                                 const BLOCK_DIAGONAL_MATRIX3 &B);
  friend BLOCK_DIAGONAL_MATRIX3 operator-(const BLOCK_DIAGONAL_MATRIX3 &A,
                                          const BLOCK_DIAGONAL_MATRIX3 &B);
