...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void drawPlaneConstraints(const TRIANGLE_MESH *triangleMesh,
                          const SHELL::TIMESTEPPER *stepper) {
  ...
  for (unsigned int x = 0; x < constraints.size(); x++) {
    ...
    glVertex3f(closestPoint[0], closestPoint[1], closestPoint[2]);
    glVertex3f(closestPoint[0] + normal[0], closestPoint[1] + normal[1],
               closestPoint[2] + normal[2]);
    glEnd();
  }
}
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void drawPlaneConstraints(const STRAND_MESH *strandMesh,
                          const STRAND::TIMESTEPPER *stepper) {
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void drawKinematicConstraints(const TRIANGLE_MESH *triangleMesh,
                              const SHELL::TIMESTEPPER *stepper) {
  const vector<VECTOR3> &vertices = triangleMesh->vertices();
  const vector<KINEMATIC_CONSTRAINT> &constraints =
      stepper->kinematicConstraints();
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void drawKinematicConstraints(const STRAND_MESH *strandMesh,
                              const STRAND::TIMESTEPPER *stepper) {
  const vector<VECTOR3> &vertices = strandMesh->vertices();
  const vector<KINEMATIC_CONSTRAINT> &constraints =
      stepper->kinematicConstraints();
...
///////////////////////////////////////////////////////////////////////
void drawStrandMesh(const STRAND_MESH &mesh, const int highlight,
...
// draw the lines in a strand mesh
///////////////////////////////////////////////////////////////////////
void drawStrandMeshOld(const STRAND_MESH &mesh, const int highlight,
                       const bool drawVertices) {
...
void drawSphere(const SPHERE &sphere) {
  ...
  glRotatef((180.0 / M_PI) * R.angle(), R.axis().x(), R.axis().y(),
            R.axis().z());
...
void drawAABB(const AABB_NODE &node) { drawAABB(node.mins, node.maxs); }

///////////////////////////////////////////////////////////////////////
// draw a AABB tree at a specific depth
///////////////////////////////////////////////////////////////////////
void drawAABBTree(const AABB_NODE *node, const int drawDepth,
...
void drawCollisions(const STRAND_MESH &mesh) {
  ...
  const vector<VECTOR3> &vertices = mesh.vertices();
  const vector<pair<VECTOR2, VECTOR2>> &coordinates =
      mesh.edgeEdgeCoordinates();
  ...
  for (unsigned int x = 0; x < collisions.size(); x++) {
    ...
    const VECTOR3 middle0 = coordinate0[0] * vertices[edge0[0]] +
                            coordinate0[1] * vertices[edge0[1]];
    const VECTOR3 middle1 = coordinate1[0] * vertices[edge1[0]] +
                            coordinate1[1] * vertices[edge1[1]];
