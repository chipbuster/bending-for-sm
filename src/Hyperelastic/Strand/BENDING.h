...
//
// The Bergou 2008 and 2010 models use a kappa term, but an isotropic model
// would just use a theta (bending angle) term. Going to veirfy against existing
// codes first before settling on a single interface.
///////////////////////////////////////////////////////////////////////////////////////////////////
class BENDING {
public:
  ...
  */
  virtual VECTOR9 spatialGradient(
      const VECTOR2 &restKappa, const VECTOR2 &kappa, const VECTOR3 &tangent,
      const VECTOR3 &previousTangent, const REAL &restLength,
      const REAL &previousRestLength, const REAL &length,
      const REAL &previousLength, const MATRIX2 &perCornerKappa,
      const std::vector<VECTOR3> &director1,
      const std::vector<VECTOR3> &director2, const VECTOR3 &kb) const = 0;
