...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
std::string SIN_BENDING::name() const { return std::string("SIN_BENDING"); }

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
REAL SIN_BENDING::psi(const MATRIX2 &B, const VECTOR2 &kappa,
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX3x2 SIN_BENDING::edgeGradient(const MATRIX3x2 &E, const MATRIX2 &B,
                                    const MATRIX3x2 &M, const VECTOR2 &kappa,
                                    const VECTOR2 &kappaBar) const {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
VECTOR2 SIN_BENDING::twistGradient(const MATRIX3x2 &E, const MATRIX2 &B,
                                   const MATRIX3x2 &M0, const MATRIX3x2 &M1,
                                   const VECTOR2 &kappa,
                                   const VECTOR2 &kappaBar) const {
...
SIN_BENDING::binormalGradient(const MATRIX3x2 &E) const {
...
SIN_BENDING::binormalHessian00(const MATRIX3x2 &E) const {
  const VECTOR3 &e0 = E.col(0);
  const VECTOR3 &e1 = E.col(1);
  const VECTOR3 kb = binormal(E);
  const REAL e0norm = e0.norm();
  ...
  const MATRIX3 X =
      (1.0 / denom) * ((2.0 * e0[0] / denom) * (kb * e0.transpose()) -
                       G0.col(0) * e0.transpose() - kb * ex.transpose() +
                       e0[0] / (e0norm * e1norm) * cross1);
  const MATRIX3 Y =
      (1.0 / denom) * ((2.0 * e0[1] / denom) * (kb * e0.transpose()) -
                       G0.col(1) * e0.transpose() - kb * ey.transpose() +
                       e0[1] / (e0norm * e1norm) * cross1);
  const MATRIX3 Z =
      (1.0 / denom) * ((2.0 * e0[2] / denom) * (kb * e0.transpose()) -
                       G0.col(2) * e0.transpose() - kb * ez.transpose() +
                       e0[2] / (e0norm * e1norm) * cross1);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::tuple<MATRIX3, MATRIX3, MATRIX3>
SIN_BENDING::binormalHessian11(const MATRIX3x2 &E) const {
  const VECTOR3 &e0 = E.col(0);
  const VECTOR3 &e1 = E.col(1);
  const VECTOR3 kb = binormal(E);
  const REAL e0norm = e0.norm();
  ...
  const MATRIX3 X =
      (1.0 / denom) * ((2.0 * e1[0] / denom) * (kb * e1.transpose()) -
                       G1.col(0) * e1.transpose() - kb * ex.transpose() -
                       e1[0] / (e0norm * e1norm) * cross0);
  const MATRIX3 Y =
      (1.0 / denom) * ((2.0 * e1[1] / denom) * (kb * e1.transpose()) -
                       G1.col(1) * e1.transpose() - kb * ey.transpose() -
                       e1[1] / (e0norm * e1norm) * cross0);
  const MATRIX3 Z =
      (1.0 / denom) * ((2.0 * e1[2] / denom) * (kb * e1.transpose()) -
                       G1.col(2) * e1.transpose() - kb * ez.transpose() -
                       e1[2] / (e0norm * e1norm) * cross0);
  return std::make_tuple(X, Y, Z);
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::tuple<MATRIX3, MATRIX3, MATRIX3>
SIN_BENDING::binormalHessian01(const MATRIX3x2 &E) const {
  const VECTOR3 &e0 = E.col(0);
  const VECTOR3 &e1 = E.col(1);
  const REAL e0norm = e0.norm();
  const REAL e1norm = e1.norm();
  ...
  const MATRIX3 X = -(1.0 / e0dot) * G1.col(0) * e0.transpose() +
                    e1[0] / (denom * e1dot) * cross1 - 1.0 / denom * crossX;
  const MATRIX3 Y = -(1.0 / e0dot) * G1.col(1) * e0.transpose() +
                    e1[1] / (denom * e1dot) * cross1 - 1.0 / denom * crossY;
  const MATRIX3 Z = -(1.0 / e0dot) * G1.col(2) * e0.transpose() +
                    e1[2] / (denom * e1dot) * cross1 - 1.0 / denom * crossZ;
  return std::make_tuple(X, Y, Z);
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 SIN_BENDING::edgeHessian(const MATRIX3x2 &E, const MATRIX2 &B,
                                 const MATRIX3x2 &M,
                                 const VECTOR2 &kappaBar) const {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX2 SIN_BENDING::twistHessian(const MATRIX3x2 &E, const MATRIX2 &B,
                                  const MATRIX3x2 &M0, const MATRIX3x2 &M1,
                                  const VECTOR2 &kappa,
                                  const VECTOR2 &kappaBar) const {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
std::pair<MATRIX3x2, MATRIX3x2>
SIN_BENDING::mixedHessian(const MATRIX3x2 &E, const MATRIX2 &B,
                          const MATRIX3x2 &M0, const MATRIX3x2 &M1,
                          const MATRIX3x2 &M, const VECTOR2 &kappa,
                          const VECTOR2 &kappaBar) const {
  const VECTOR2 rhs = B * (kappa - kappaBar);
  ...
  MATRIX3x2 H0, H1;
  H0.col(0) = -(E0.transpose() * M0 * rhs) -
              (E0.transpose() * M * B * M0.transpose() * ks);
  H0.col(1) = -(E0.transpose() * M1 * rhs) -
              (E0.transpose() * M * B * M1.transpose() * ks);

  H1.col(0) = -(E1.transpose() * M0 * rhs) -
              (E1.transpose() * M * B * M0.transpose() * ks);
  H1.col(1) = -(E1.transpose() * M1 * rhs) -
              (E1.transpose() * M * B * M1.transpose() * ks);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
VECTOR11 SIN_BENDING::gradient(const MATRIX3x2 &E, const MATRIX2 &B,
                               const MATRIX3x2 &M0, const MATRIX3x2 &M1,
                               const MATRIX3x2 &M, const VECTOR2 &kappa,
                               const VECTOR2 &kappaBar) const {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX11 SIN_BENDING::hessian(const MATRIX3x2 &E, const MATRIX2 &B,
                              const MATRIX3x2 &M0, const MATRIX3x2 &M1,
                              const MATRIX3x2 &M, const VECTOR2 &kappa,
                              const VECTOR2 &kappaBar) const {
  MATRIX11 result;
  ...
  // off-diagonal terms
  std::pair<MATRIX3x2, MATRIX3x2> mixed =
      mixedHessian(E, B, M0, M1, M, kappa, kappaBar);
