...
QUADRATIC_F_BENDING::QUADRATIC_F_BENDING(const REAL &mu) : TAN_BENDING(mu) {}
...
REAL QUADRATIC_F_BENDING::psi(const MATRIX3x2 &E, const REAL &theta0,
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX3x2 QUADRATIC_F_BENDING::PK1(const MATRIX3x2 &E,
...
MATRIX3x2 QUADRATIC_F_BENDING::PK1(const MATRIX3x2 &E, const REAL &theta0,
                                   const bool inverted) const {
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  // const REAL cosTheta = e0.dot(e1) / (e0.norm() * e1.norm());
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 QUADRATIC_F_BENDING::hessian(const MATRIX3x2 &E,
                                     const REAL &theta0) const {
  ...
  // compute the blocks
  const MATRIX3 B00 =
      (dot0 * N - 2 * e0perp * e0.transpose() + (-E0 * pnpe0) * dot0) / dot0 /
      dot0;
  const MATRIX3 B01 = -E0 * pnpe1 / dot0;
  const MATRIX3 B11 =
      (-dot1 * N + 2 * e1perp * e1.transpose() + (E1 * pnpe1) * dot1) / dot1 /
      dot1;
  const MATRIX3 B10 = E1 * pnpe0 / dot1;
  MATRIX6 hTehta;
  hTehta << B00, B01, B10, B11;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 QUADRATIC_F_BENDING::hessian(const MATRIX3x2 &E, const REAL &theta0,
                                     const bool inverted) const {
  // compute the Hessian of theta
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
...
MATRIX6 QUADRATIC_F_BENDING::clampedHessian(const MATRIX3x2 &E,
                                            const REAL &theta0) const {
  const VECTOR3 e0 = E.col(0);
  const VECTOR3 e1 = E.col(1);
  const REAL cosTheta = clamp(e0.dot(e1) / (e0.norm() * e1.norm()), -1.0, 1.0);
