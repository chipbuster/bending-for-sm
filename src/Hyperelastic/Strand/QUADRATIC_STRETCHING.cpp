...
QUADRATIC_STRETCHING::QUADRATIC_STRETCHING(const REAL &mu) : STRETCHING(mu) {}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
VECTOR6 QUADRATIC_STRETCHING::spatialGradient(const std::vector<VECTOR3> &p,
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6 QUADRATIC_STRETCHING::spatialHessian(const std::vector<VECTOR3> &p,
                                             const REAL &dmInv) const {
  const VECTOR3 f = (p[1] - p[0]) * dmInv;
  ...
  // this could be optimized by only computing the upper triangle of the
  // outer-product and mirroring it, and then populating the kron term by hand,
  // since it's mostly zeros
  return (lambda0 - lambda1) * qx * qx.transpose() +
         (lambda1 * dmInv * dmInv) * kron;
}

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
MATRIX6
QUADRATIC_STRETCHING::spatialClampedHessian(const std::vector<VECTOR3> &p,
                                            const REAL &dmInv) const {
  const VECTOR3 f = (p[1] - p[0]) * dmInv;
...
MATRIX3 QUADRATIC_STRETCHING::clampedHessian(const VECTOR3 &f) const {
  ...
  return (lambda0 - lambda1) * (q0 * q0.transpose()) +
         lambda1 * MATRIX3::Identity();
}
