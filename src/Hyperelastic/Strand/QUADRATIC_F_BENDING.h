...
#ifndef STRAND_QUADRATIC_F_BENDING_H
#define STRAND_QUADRATIC_F_BENDING_H
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
class QUADRATIC_F_BENDING : public TAN_BENDING {
public:
  ...
  virtual MATRIX6 hessian(const MATRIX3x2 &E,
                          const REAL &theta0) const override;
  virtual MATRIX6 clampedHessian(const MATRIX3x2 &E,
                                 const REAL &theta0) const override;

  virtual REAL psi(const MATRIX3x2 &E, const REAL &theta0,
                   const bool inverted) const override;
