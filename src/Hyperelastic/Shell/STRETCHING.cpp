...
// convert Young's modulus (E) and Poisson's ratio (nu) to Lam\'{e} parameters
//
// Tamstorf claims that Lambda computation should be slightly different from the
// volume case in his dissertation, "Large scale simulation of cloth and hair
// with contact", 2016
//
// Here we use the formula from page 34, Equation 4.2. The original volumetric
// conversion is commented out.
///////////////////////////////////////////////////////////////////////////////////////////////////
