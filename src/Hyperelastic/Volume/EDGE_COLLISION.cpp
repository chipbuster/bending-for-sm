...
std::string EDGE_COLLISION::name() const { return "EDGE_COLLISION"; }

///////////////////////////////////////////////////////////////////////
// convert the 12-vector in a way that imposes a consistent tet
// ordering for vertices and edges
///////////////////////////////////////////////////////////////////////
void EDGE_COLLISION::getVerticesAndEdges(const VECTOR12 &x, vector<VECTOR3> &v,
                                         vector<VECTOR3> &e) {
  v.resize(4);
  for (int i = 0; i < 4; i++) {
    v[i][0] = x[i * 3];
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
REAL EDGE_COLLISION::psi(const vector<VECTOR3> &vertices, const VECTOR2 &a,
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
REAL EDGE_COLLISION::psi(const VECTOR12 &x, const VECTOR2 &a,
                         const VECTOR2 &b) const {
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
REAL EDGE_COLLISION::psiNegated(const VECTOR12 &x, const VECTOR2 &a,
                                const VECTOR2 &b) const {
  // convert to vertices and edges
  vector<VECTOR3> v;
  vector<VECTOR3> e;
  ...
  // Harmon  et al. says that if the two edges are nearly parallel, a
  // vertex-face will pick up the slack, so ignore it. But ... the collision is
  // still well defined from the perspective of the pinned version of this
  // energy.
  //
  // Regardless, the conditioning of the force goes crazy in the near-parallel
  // case, so we should skip it here.
  if (nearlyParallelEdges(e))
    return 0.0;

  // get the normal
  VECTOR3 n = e[1].cross(e[0]);

  // if the two are co-linear, skip the normalization (this may be redundant
  // with the nearlyParallel check)
  if (n.norm() > 1e-8)
    n = n / n.norm();
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
VECTOR12 EDGE_COLLISION::gradient(const VECTOR12 &x, const VECTOR2 &a,
                                  const VECTOR2 &b) const {
  // convert to vertices and edges
  vector<VECTOR3> v;
  vector<VECTOR3> e;
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
VECTOR12 EDGE_COLLISION::gradientNegated(const VECTOR12 &x, const VECTOR2 &a,
                                         const VECTOR2 &b) const {
  // convert to vertices and edges
  vector<VECTOR3> v;
  vector<VECTOR3> e;
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
MATRIX12 EDGE_COLLISION::hessian(const VECTOR12 &x, const VECTOR2 &a,
                                 const VECTOR2 &b) const {
  // convert to vertices and edges
  vector<VECTOR3> v;
  vector<VECTOR3> e;
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
MATRIX12 EDGE_COLLISION::hessianNegated(const VECTOR12 &x, const VECTOR2 &a,
                                        const VECTOR2 &b) const {
  // convert to vertices and edges
  vector<VECTOR3> v;
  vector<VECTOR3> e;
...
MATRIX12 EDGE_COLLISION::springLengthHessian(const std::vector<VECTOR3> &e,
  ...
  MATRIX12 contracted =
      diff[0] * normalH[0] + diff[1] * normalH[1] + diff[2] * normalH[2];
  contracted *= sign;
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
MATRIX12 EDGE_COLLISION::clampedHessian(const VECTOR12 &x, const VECTOR2 &a,
                                        const VECTOR2 &b) const {
...
///////////////////////////////////////////////////////////////////////
bool EDGE_COLLISION::nearlyParallelVertices(const vector<VECTOR3> &x) {
  assert(x.size() == 4);
  VECTOR12 xFlat;
  ...
  vector<VECTOR3> v;
  vector<VECTOR3> e;
  getVerticesAndEdges(xFlat, v, e);

  return nearlyParallelEdges(e);
}

///////////////////////////////////////////////////////////////////////
// are the two edges nearly parallel?
///////////////////////////////////////////////////////////////////////
bool EDGE_COLLISION::nearlyParallelEdges(const vector<VECTOR3> &e) {
