...
public:
  ...
  virtual REAL psi(const MATRIX3 &U, const VECTOR3 &Sigma,
                   const MATRIX3 &V) const;

  // Computes the first Piola-Kirchoff PK1 stress
  virtual MATRIX3 PK1(const MATRIX3 &F) const;
  virtual MATRIX3 PK1(const MATRIX3 &U, const VECTOR3 &Sigma,
                      const MATRIX3 &V) const;

  // Computes the derivative of the PK1 stress
  virtual MATRIX9 hessian(const MATRIX3 &F) const;
  virtual MATRIX9 hessian(const MATRIX3 &U, const VECTOR3 &Sigma,
                          const MATRIX3 &V) const;

  // Computes the derivative of the PK1 stress, clamped to semi-positive
  // definiteness
  virtual MATRIX9 clampedHessian(const MATRIX3 &F) const;
  virtual MATRIX9 clampedHessian(const MATRIX3 &U, const VECTOR3 &Sigma,
                                 const MATRIX3 &V) const;
