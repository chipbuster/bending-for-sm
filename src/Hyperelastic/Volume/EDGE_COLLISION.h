...
public:
  ...
  REAL psi(const std::vector<VECTOR3> &v, const VECTOR2 &a,
  ...
  REAL psiNegated(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                  const VECTOR2 &b) const;
  virtual REAL psiNegated(const VECTOR12 &x, const VECTOR2 &a,
                          const VECTOR2 &b) const;

  // This is the *gradient* of psi. The force is the *negative* gradient of psi.
  VECTOR12 gradient(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                    const VECTOR2 &b) const;
  virtual VECTOR12 gradient(const VECTOR12 &x, const VECTOR2 &a,
                            const VECTOR2 &b) const;

  // negated version of gradient, if it's already intersecting
  VECTOR12 gradientNegated(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                           const VECTOR2 &b) const;
  virtual VECTOR12 gradientNegated(const VECTOR12 &x, const VECTOR2 &a,
                                   const VECTOR2 &b) const;

  MATRIX12 hessian(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                   const VECTOR2 &b) const;
  virtual MATRIX12 hessian(const VECTOR12 &x, const VECTOR2 &a,
                           const VECTOR2 &b) const;

  MATRIX12 hessianNegated(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                          const VECTOR2 &b) const;
  virtual MATRIX12 hessianNegated(const VECTOR12 &x, const VECTOR2 &a,
                                  const VECTOR2 &b) const;

  MATRIX12 clampedHessian(const std::vector<VECTOR3> &v, const VECTOR2 &a,
                          const VECTOR2 &b) const;
  virtual MATRIX12 clampedHessian(const VECTOR12 &x, const VECTOR2 &a,
                                  const VECTOR2 &b) const;

  MATRIX12 clampedHessianNegated(const std::vector<VECTOR3> &v,
                                 const VECTOR2 &a, const VECTOR2 &b) const;
  virtual MATRIX12 clampedHessianNegated(const VECTOR12 &x, const VECTOR2 &a,
                                         const VECTOR2 &b) const;
