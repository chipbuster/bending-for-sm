...
STRAND_MESH_FASTER::STRAND_MESH_FASTER(const vector<VECTOR3> &restVertices,
                                       ...
                                       const REAL &radiusB)
    : STRAND_MESH(restVertices, strandIndices, E, nu, density, radiusA,
                  radiusB) {
...
///////////////////////////////////////////////////////////////////////
SPARSE_MATRIX STRAND_MESH_FASTER::computeStretchingHessian(
...
#pragma omp for schedule(static)
  for (unsigned int i = 0; i < _totalEdges; i++) {
    ...
    // const MATRIX6 H = _restEdgeLengths[i] *
...
// this is all super-slow, should be optimized
///////////////////////////////////////////////////////////////////////
SPARSE_MATRIX STRAND_MESH_FASTER::computeStretchingClampedHessian(
    const STRAND::STRETCHING &stretching) const {
...
///////////////////////////////////////////////////////////////////////
SPARSE_MATRIX
STRAND_MESH_FASTER::computeEdgeEdgeCollisionClampedHessian() const {
  TIMER functionTimer(string("STRAND_MESH_FASTER::") + string(__FUNCTION__));
...
// energies
///////////////////////////////////////////////////////////////////////
SPARSE_MATRIX STRAND_MESH_FASTER::computeClampedElasticityHessian(
    const STRAND::STRETCHING &stretching) {
