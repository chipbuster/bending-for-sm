...
/// sparse real symmetric matrix \f$A\f$, i.e., calculating \f$y=Ax\f$ for any
/// vector \f$x\f$. It is mainly used in the SymEigsSolver eigen solver.
///
...
public:
  ...
  ///
  SparseSymMatProd(ConstGenericSparseMatrix &mat) : m_mat(mat) {}
