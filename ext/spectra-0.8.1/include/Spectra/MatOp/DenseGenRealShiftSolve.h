...
/// \ingroup MatOp
///
/// This class defines the shift-solve operation on a general real matrix
/// \f$A\f$, i.e., calculating \f$y=(A-\sigma I)^{-1}x\f$ for any real
/// \f$\sigma\f$ and vector \f$x\f$. It is mainly used in the
/// GenEigsRealShiftSolver eigen solver.
///
template <typename Scalar> class DenseGenRealShiftSolve {
private:
