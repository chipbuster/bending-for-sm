...
/// \ingroup MatOp
///
/// This class defines the shift-solve operation on a real symmetric matrix
/// \f$A\f$, i.e., calculating \f$y=(A-\sigma I)^{-1}x\f$ for any real
/// \f$\sigma\f$ and vector \f$x\f$. It is mainly used in the SymEigsShiftSolver
/// eigen solver.
///
template <typename Scalar, int Uplo = Eigen::Lower> class DenseSymShiftSolve {
private:
...
public:
  ...
  ///
  DenseSymShiftSolve(ConstGenericMatrix &mat) : m_mat(mat), m_n(mat.rows()) {
