...
/// solver in the regular inverse mode. For a sparse and positive definite
/// matrix \f$B\f$, it implements the matrix-vector product \f$y=Bx\f$ and the
/// linear equation solving operation \f$y=B^{-1}x\f$.
///
/// This class is intended to be used with the SymGEigsSolver generalized eigen
/// solver in the regular inverse mode.
///
