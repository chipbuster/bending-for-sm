...
/// either
///                       use the wrapper classes such as DenseGenRealShiftSolve
///                       and SparseGenRealShiftSolve, or define their own that
...
public:
  ...
  ///               DenseGenRealShiftSolve, or define their own that implements
  ///               all the public member functions as in
  ///               DenseGenRealShiftSolve.
  ...
  ///               \f$nev+2 \le ncv \le n\f$, and is advised to take \f$ncv \ge
  ///               2\cdot nev + 1\f$.
