...
public:
  ...
  ///                   for example `LARGEST_ALGE` indicates that largest
  ///                   eigenvalues come first. Note that this argument is only
  ///                   used to
  ...
  ///                   parameter `SelectionRule` of SymEigsSolver.
  ///
  ...
  ///
  virtual Matrix eigenvectors() const { return eigenvectors(m_nev); }
};
