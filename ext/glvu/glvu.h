...
#endif
#define INERTIA_MINMOVE                                                        \
  2                  // AMOUNT (in pixels) TO MOVE TO INVOKE INERTIAL SYSTEM
#define MAX_GLVUS 33 // MAX NUMBER OF WINDOWS PLUS 1 SUPPORTED IN ONE APP
#define FPS_INTEGRATE_INTERVAL                                                 \
  1.0f // MINIMUM NUMBER OF SECONDS TO INTEGRATE FRAME-RATE OVER
...
public:
  ...
  GLVU();
  virtual ~GLVU();
  int Init(char *WindowTitle, unsigned int VisualMode, int WindowStartX,
           int WindowStartY, int WindowWidth, int WindowHeight);
  ...
  void SetAllCams(const glvuVec3f &WorldMin, const glvuVec3f &WorldMax,
                  ...
                  const glvuVec3f &viewup, float Yfov, float Aspect,
                  float NearFactor, float FarFactor);
  void AllCamsPerspectiveChange(float Yfov, float Aspect, float Ndist,
                                float Fdist);
  ...
  void GetPixelRay(int sx, int sy, int ww, int wh, glvuVec3f *Start,
                   glvuVec3f *Dir) const;
 ...
 */
inline int GLVU::GetPlaybackOn() const { return (PlaybackOn); }
 ...
 *     StartPlayback, EndPlayback, GetModelviewMatrix
 */
inline int GLVU::GetRecordingOn() const { return (RecordingOn); }
 ...
 *     StartPlayback, EndPlayback, GetModelviewMatrix
 */
inline FILE *GLVU::GetPathFile() const { return RecordPlaybackFP; }
 ...
 */
inline void GLVU::SelectCam(int WhichCam) { Cam = &Cams[WhichCam]; }

/// Return the index of the active camera.
inline int GLVU::GetCurrentCamId() const { return (Cam - &Cams[0]); }

/// Return a pointer to the active camera.
inline Camera *GLVU::GetCurrentCam() { return (Cam); }
 ...
 *  @see SelectCam
 */
inline void GLVU::SetCurrentCam(Camera *NewCam) { Cam = NewCam; }
 ...
 */
inline Camera *GLVU::GetCam(int WhichCam) { return (&Cams[WhichCam]); }
 ...
 */
inline int GLVU::GetInOutMode() const { return (InsideLookingOutMode); }
 ...
 * @see SetInOutMode, ToggleInOutMode.
 */
inline void GLVU::SetInOutMode(int Bool) { InsideLookingOutMode = Bool; }
 ...
 */
inline void GLVU::SetOrigCam(Camera *Cam) { OrigCam.Copy(*Cam); }
 ...
 * @see SetWorldNavMode
 */
inline const glvuVec3f &GLVU::GetViewUp() const { return (ViewUp); }

/**
 * Returns the global "center" of the world, as set by SetWorldCenter() or
 * (indirectly) by SetAllCams().
 */
inline const glvuVec3f &GLVU::GetWorldCenter() const { return WorldCenter; }

/**
 * Sets the global "center" of the world.  Also set (indirectly) by
 * SetAllCams().
 ...
 * (indirectly) by SetAllCams().
 */
inline float GLVU::GetWorldRadius() const { return WorldRadius; }

/**
 * Sets the global "radius" of the world.
 * @see GetWorldRadius
 */
inline void GLVU::SetWorldRadius(float newRadius) { WorldRadius = newRadius; }

/**
 * Sets the global "up" vector.
 * @see GetViewUp
 */
inline void GLVU::SetViewUp(glvuVec3f viewup) { ViewUp = viewup; }
 ...
 */
inline void GLVU::SetMoveSpeed(float speed) { moveSpeed = speed; }
 ...
 */
inline float GLVU::GetMoveSpeed() const { return moveSpeed; }
 ...
 * @see InitMenu
 */
inline int GLVU::GetMainMenuID() const { return (MainMenuID); }
 ...
 * @see SetWorldNavMode
 */
inline int GLVU::GetWorldNavMode() const { return (WorldNavMode); }
 ...
 *
 * GLVU uses the following default keyboard accelerators to switch between
 * modes:
 *
 ...
 *
 * @see GetWorldNavMode */
inline void GLVU::SetWorldNavMode(int mode) { WorldNavMode = mode; }
 ...
 */
inline bool GLVU::GetLeftButtonDown() const { return (LeftButtonDown); }

/**
 * Returns true if the middle button was down
 * last time the Mouse() or Motion() callback got called.
 */
inline bool GLVU::GetMiddleButtonDown() const { return (MiddleButtonDown); }

/**
 * Returns true if the right button was down
 * last time the Mouse() or Motion() callback got called.
 */
inline bool GLVU::GetRightButtonDown() const { return (RightButtonDown); }

/**
 * Returns true if the Alt key was down
 * last time the Mouse() or Keyboard() callback got called.
 */
inline bool GLVU::GetAltDown() const { return (AltPressed); }
/**
 * Returns true if the Shift key was down
 * last time the Mouse() or Keyboard() callback got called.
 */
inline bool GLVU::GetShiftDown() const { return (ShiftPressed); }
/**
 * Returns true if the Control key was down
 * last time the Mouse() or Keyboard() callback got called.
 */
inline bool GLVU::GetCtrlDown() const { return (CtrlPressed); }
 ...
 */
inline int GLVU::GetInertiaOn() const { return (InertiaOn); }
 ...
 * @see SetInertiaEnabled
 */
inline int GLVU::GetInertiaEnabled() const { return (InertiaEnabled); }

/// Enable or disable the GLVU's inertia feature
/**
 * @see GetInertiaEnabled
 */
inline void GLVU::SetInertiaEnabled(int Bool) { InertiaEnabled = Bool; }
 ...
 */
inline int GLVU::GetInertiaDelay() const { return (InertiaDelay); }
 ...
 */
inline void GLVU::SetInertiaDelay(int msec) { InertiaDelay = msec; }
 ...
 * reason to call this.
 */
inline void GLVU::SetInertiaFunc(GLVU::InertiaFunc f) { UserInertiaFunc = f; }
 ...
 */
inline int GLVU::GetWindowID() const { return WindowID; }
 ...
 *  @see GetGLVU(void)
 */
inline void GLVU::MakeCurrent() { glutSetWindow(WindowID); }
 ...
 */
inline GLVU *GLVU::GetCurrent() { return GLVUs[glutGetWindow()]; }

/// Returns a pointer to the GLVU that corresponds to the specified GLUT window
/// ID.
/**
 ...
 */
inline GLVU *GLVU::GetGLVU(int WindowID) { return GLVUs[WindowID]; }
 ...
 * @see MakeCurrent
 */
inline GLVU *GLVU::GetGLVU(void) { return GLVUs[glutGetWindow()]; }
