...
inline int GetFontHeight() { return (GetFontHeight(CurrentFont)); }

inline int GetFontHeight(int fontid) { return (FontHeights[fontid]); }
...
// call to Text(). Newline chars ('\n') in the string advance the raster
// position to the next line down (Newline chars are ignored in string
