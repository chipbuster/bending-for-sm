...
bool convergenceTestHessian(const HOBAK::SHELL::BENDING *material,
  ...
  cout << "=============================================================== "
       << endl;
  cout << " VERIFYING Shell Bending hessian for " << material->name().c_str()
       << endl;
  cout << "=============================================================== "
       << endl;
  ...
  while (eps > 1e-8) {
    ...
    cout << "eps: " << eps << " relative diff: " << relativeDiffNorm
         << "\t abs diff: " << absDiffNorm << endl;
...
bool convergenceTestGradient(const HOBAK::SHELL::BENDING *material,
  ...
  cout << "=============================================================== "
       << endl;
  cout << " VERIFYING Shell Bending gradient for " << material->name().c_str()
       << endl;
  cout << "=============================================================== "
       << endl;
